            ...
            <div key={index} className="relative group w-full sm:w-auto">
              <div
                className={`
                  ...
                  ${index === 4
                    ? 'border-sky-300 bg-sky-50 hover:shadow-sky-100/50'
                    : 'border-border hover:border-sky-200 hover:shadow-sky-50/50'
                  }
                `}
              >
                <div className="text-3xl mb-2">{tier.emoji}</div>
                <div className={`font-bold text-sm ${index === 4 ? 'text-sky-600' : 'text-dark'}`}>
                  {tier.name}
                </div>
